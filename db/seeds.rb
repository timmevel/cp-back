...
pots_test2 = Pot.create(user_id: '5', description: "Melomane depuis toujours, je recherche actuellement une flûte pour me divertir et divertir les autres en ces temps de fêtes. Merci à tous pour votre aide et merci à la communauté Coud'Pouce.", cash_demand: "40", cash_collected: "0", credits_collected: "0")
